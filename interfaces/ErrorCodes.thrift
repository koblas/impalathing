...
const list<string> TErrorMessage = [
  ...
  "Could not create files in any configured scratch directories (--scratch_dirs=$0) on backend '$1'. See logs for previous errors that may have prevented creating or writing scratch files.",
