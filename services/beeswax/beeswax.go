...
type TQueryOptionLevel int64
const (
  TQueryOptionLevel_REGULAR TQueryOptionLevel = 0
  TQueryOptionLevel_ADVANCED TQueryOptionLevel = 1
  TQueryOptionLevel_DEVELOPMENT TQueryOptionLevel = 2
  TQueryOptionLevel_DEPRECATED TQueryOptionLevel = 3
)

func (p TQueryOptionLevel) String() string {
  switch p {
  case TQueryOptionLevel_REGULAR: return "REGULAR"
  case TQueryOptionLevel_ADVANCED: return "ADVANCED"
  case TQueryOptionLevel_DEVELOPMENT: return "DEVELOPMENT"
  case TQueryOptionLevel_DEPRECATED: return "DEPRECATED"
  }
  return "<UNSET>"
}

func TQueryOptionLevelFromString(s string) (TQueryOptionLevel, error) {
  switch s {
  case "REGULAR": return TQueryOptionLevel_REGULAR, nil 
  case "ADVANCED": return TQueryOptionLevel_ADVANCED, nil 
  case "DEVELOPMENT": return TQueryOptionLevel_DEVELOPMENT, nil 
  case "DEPRECATED": return TQueryOptionLevel_DEPRECATED, nil 
  }
  return TQueryOptionLevel(0), fmt.Errorf("not a valid TQueryOptionLevel string")
}


func TQueryOptionLevelPtr(v TQueryOptionLevel) *TQueryOptionLevel { return &v }

func (p TQueryOptionLevel) MarshalText() ([]byte, error) {
return []byte(p.String()), nil
}

func (p *TQueryOptionLevel) UnmarshalText(text []byte) error {
q, err := TQueryOptionLevelFromString(string(text))
if (err != nil) {
return err
}
*p = q
...
func (p *TQueryOptionLevel) Scan(value interface{}) error {
v, ok := value.(int64)
if !ok {
return errors.New("Scan value is not int64")
}
*p = TQueryOptionLevel(v)
return nil
}

func (p * TQueryOptionLevel) Value() (driver.Value, error) {
  if p == nil {
    return nil, nil
  }
return int64(*p), nil
...
type ConfigVariable struct {
  ...
  Level *TQueryOptionLevel `thrift:"level,4" db:"level" json:"level,omitempty"`
}
...
var ConfigVariable_Level_DEFAULT TQueryOptionLevel
func (p *ConfigVariable) GetLevel() TQueryOptionLevel {
  if !p.IsSetLevel() {
    return ConfigVariable_Level_DEFAULT
  }
return *p.Level
}
func (p *ConfigVariable) IsSetLevel() bool {
  return p.Level != nil
}
...
func (p *ConfigVariable)  ReadField4(iprot thrift.TProtocol) error {
  if v, err := iprot.ReadI32(); err != nil {
  return thrift.PrependError("error reading field 4: ", err)
} else {
  temp := TQueryOptionLevel(v)
  p.Level = &temp
}
  return nil
}
...
func (p *ConfigVariable) writeField4(oprot thrift.TProtocol) (err error) {
  if p.IsSetLevel() {
...
// Deprecated: Use NewBeeswaxService instead
...
func (p *BeeswaxServiceClient) Query(ctx context.Context, query *Query) (r *QueryHandle, err error) {
  ...
  if err = p.c.Call(ctx, "query", &_args3, &_result4); err != nil {
    return
  }
  switch {
...
func (p *BeeswaxServiceClient) ExecuteAndWait(ctx context.Context, query *Query, clientCtx LogContextId) (r *QueryHandle, err error) {
  ...
  if err = p.c.Call(ctx, "executeAndWait", &_args5, &_result6); err != nil {
    return
  }
  switch {
...
func (p *BeeswaxServiceClient) Explain(ctx context.Context, query *Query) (r *QueryExplanation, err error) {
  ...
  if err = p.c.Call(ctx, "explain", &_args7, &_result8); err != nil {
    return
  }
  switch {
...
func (p *BeeswaxServiceClient) Fetch(ctx context.Context, query_id *QueryHandle, start_over bool, fetch_size int32) (r *Results, err error) {
  ...
  if err = p.c.Call(ctx, "fetch", &_args9, &_result10); err != nil {
    return
  }
  switch {
...
func (p *BeeswaxServiceClient) GetState(ctx context.Context, handle *QueryHandle) (r QueryState, err error) {
  ...
  if err = p.c.Call(ctx, "get_state", &_args11, &_result12); err != nil {
    return
  }
  switch {
...
func (p *BeeswaxServiceClient) GetResultsMetadata(ctx context.Context, handle *QueryHandle) (r *ResultsMetadata, err error) {
  ...
  if err = p.c.Call(ctx, "get_results_metadata", &_args13, &_result14); err != nil {
    return
  }
  switch {
...
func (p *BeeswaxServiceClient) Echo(ctx context.Context, s string) (r string, err error) {
  ...
  if err = p.c.Call(ctx, "echo", &_args15, &_result16); err != nil {
    return
  }
...
func (p *BeeswaxServiceClient) DumpConfig(ctx context.Context) (r string, err error) {
  ...
  if err = p.c.Call(ctx, "dump_config", &_args17, &_result18); err != nil {
    return
  }
...
func (p *BeeswaxServiceClient) GetLog(ctx context.Context, context LogContextId) (r string, err error) {
  ...
  if err = p.c.Call(ctx, "get_log", &_args19, &_result20); err != nil {
    return
  }
  switch {
...
func (p *BeeswaxServiceClient) GetDefaultConfiguration(ctx context.Context, include_hadoop bool) (r []*ConfigVariable, err error) {
  ...
  if err = p.c.Call(ctx, "get_default_configuration", &_args21, &_result22); err != nil {
    return
  }
...
func (p *BeeswaxServiceClient) Close(ctx context.Context, handle *QueryHandle) (err error) {
  ...
  if err = p.c.Call(ctx, "close", &_args23, &_result24); err != nil {
    return
  }
  switch {
...
func (p *BeeswaxServiceClient) Clean(ctx context.Context, log_context LogContextId) (err error) {
  ...
  if err = p.c.Call(ctx, "clean", &_args25, &_result26); err != nil {
    return
  }
  return nil
}
